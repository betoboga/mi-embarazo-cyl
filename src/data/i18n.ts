export const arabicTranslations: Record<string, string> = {
  ...
  'Estadísticas de nacimientos - Mi Embarazo CYL': 'إحصائيات الولادات - حملي في قشتالة وليون',
  'Nacimientos en Castilla y León': 'الولادات في قشتالة وليون',
  'Evolución desde': 'التطور من',
  'por provincia.': 'حسب المقاطعة.',
  'En': 'في',
  'nacimientos': 'ولادات',
  'Desde': 'منذ',
  'de variación': 'من التغير',
  'Mínimo histórico': 'الحد الأدنى التاريخي',
  'Evolución en toda la comunidad': 'التطور في جميع أنحاء الإقليم',
  'Nacimientos totales por año,': 'إجمالي الولادات سنوياً،',
  'Busca tu municipio': 'ابحثي عن بلديتك',
  'Media de nacimientos por año en la última década (2015-2024).': 'متوسط عدد الولادات سنوياً خلال العقد الأخير (2015-2024).',
  'Escribe el nombre de tu municipio...': 'اكتبي اسم بلديتك...',
  'Por provincia en': 'حسب المقاطعة في',
  'Nacimientos registrados en cada provincia durante el último año disponible.': 'الولادات المسجلة في كل مقاطعة خلال آخر عام متاح.',
  'Fuente:': 'المصدر:',
  'Datos': 'بيانات',
  'Ver estadísticas': 'عرض الإحصائيات',
  'Cómo ha evolucionado la natalidad en tu provincia desde 1980, con datos abiertos.': 'كيف تطور معدل المواليد في مقاطعتك منذ عام 1980، باستخدام بيانات مفتوحة.',
  ...
  'En embarazos de bajo riesgo:': 'في حالات الحمل منخفضة الخطورة:',
  'Sobre la semana 8: primera consulta para datar el embarazo.': 'نحو الأسبوع الثامن: استشارة أولى لتحديد عمر الحمل.',
  'Semana 12: consulta muy importante para estimar los riesgos del embarazo, que determinarán la necesidad o no de controles adicionales.': 'الأسبوع الثاني عشر: استشارة مهمة جدًا لتقدير مخاطر الحمل، والتي ستحدد الحاجة إلى متابعات إضافية من عدمها.',
  'Semana 20: ecografía morfológica, imprescindible para estudiar detalladamente la anatomía fetal.': 'الأسبوع العشرون: الفحص المورفولوجي بالموجات فوق الصوتية، وهو ضروري لدراسة تشريح الجنين بالتفصيل.',
  'Semana 36: control del crecimiento y bienestar fetal.': 'الأسبوع السادس والثلاثون: فحص نمو الجنين وسلامته.',
  'Semana 40: suelen dar la primera cita para fisiopatología fetal.': 'الأسبوع الأربعون: يُحدَّد عادةً الموعد الأول لطب الفيزيولوجيا المرضية للجنين.',
...
export const englishTranslations: Record<string, string> = {
  ...
  'Estadísticas de nacimientos - Mi Embarazo CYL': 'Birth statistics - My Pregnancy CYL',
  'Nacimientos en Castilla y León': 'Births in Castile and León',
  'Evolución desde': 'Evolution from',
  'por provincia.': 'by province.',
  'En': 'In',
  'nacimientos': 'births',
  'Desde': 'Since',
  'de variación': 'change',
  'Mínimo histórico': 'Historical minimum',
  'Evolución en toda la comunidad': 'Evolution across the region',
  'Nacimientos totales por año,': 'Total births per year,',
  'Busca tu municipio': 'Search your municipality',
  'Media de nacimientos por año en la última década (2015-2024).': 'Average births per year over the last decade (2015-2024).',
  'Escribe el nombre de tu municipio...': 'Type your municipality name...',
  'Por provincia en': 'By province in',
  'Nacimientos registrados en cada provincia durante el último año disponible.': 'Births recorded in each province during the latest available year.',
  'Fuente:': 'Source:',
  'Datos': 'Data',
  'Ver estadísticas': 'View statistics',
  'Cómo ha evolucionado la natalidad en tu provincia desde 1980, con datos abiertos.': 'How birth rates have changed in your province since 1980, using open data.',
  ...
  'En embarazos de bajo riesgo:': 'In low-risk pregnancies:',
  'Sobre la semana 8: primera consulta para datar el embarazo.': 'Around week 8: first consultation to date the pregnancy.',
  'Semana 12: consulta muy importante para estimar los riesgos del embarazo, que determinarán la necesidad o no de controles adicionales.': 'Week 12: a very important consultation to estimate the pregnancy risks, which will determine whether additional check-ups are needed or not.',
  'Semana 20: ecografía morfológica, imprescindible para estudiar detalladamente la anatomía fetal.': 'Week 20: the morphological ultrasound scan, essential for examining fetal anatomy in detail.',
  'Semana 36: control del crecimiento y bienestar fetal.': 'Week 36: fetal growth and well-being are checked.',
  'Semana 40: suelen dar la primera cita para fisiopatología fetal.': 'Week 40: the first appointment for fetal pathophysiology is usually given.',
